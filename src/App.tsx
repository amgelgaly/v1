  ...
  import RequestPage from '@/pages/profile/orders'; // Import RequestPage from index.tsx
  import PagesRequestPage from '@/pages/orders/PagesRequest';
      ...
      <BrowserRouter>
        <ErrorBoundary> {/* Wrap Routes with ErrorBoundary */}
          ...
          <Routes>
            ...
            <Route path="/profile/orders" element={<ProtectedRoute><RequestPage /></ProtectedRoute>} /> {/* Updated route path */}
            <Route path="/request" element={<ProtectedRoute><Request /></ProtectedRoute>} />
            <Route path="/pages/orders/Request" element={<ProtectedRoute><PagesRequestPage /></ProtectedRoute>} />
